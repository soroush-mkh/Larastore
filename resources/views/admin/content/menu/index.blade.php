        ...
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section class="d-flex justify-content-between align-content-center mt-4 mb-3 border-bottom">
                    <a href="{{route('admin.content.menu.create')}}" class="btn btn-info stn-sm mb-4">
                        ایجاد منوی جدید
                    </a>
                        ...
                        @foreach($menus as $key => $menu)
                            <tr>
                                ...
                                <td class="width-16-rem text-left">
                                    ...
                                    <a href="{{route('admin.content.menu.edit',$menu->id)}}" class="btn btn-primary
                                    btn-sm"><i
                                            class="fa
                                    fa-edit"></i>
                                        ویرایش</a>

                                    <form class="d-inline" action="{{route('admin.content.menu.destroy',
                                    $menu->id)}}"
                                          method="post">
                                        @csrf
                                        {{method_field('delete')}}
