        ...
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section class="d-flex justify-content-between align-content-center mt-4 mb-3 border-bottom">
                    <a href="{{route('admin.content.page.create')}}" class="btn btn-info stn-sm mb-4">ایجاد پیج
                                                                                                      جدید</a>
                        ...
                        @foreach($pages as $key => $page)
                            <tr>
                                ...
                                <td class="width-16-rem text-left">
                                    ...
                                    <a href="{{route('admin.content.page.edit',$page->id)}}" class="btn btn-primary
                                    btn-sm"><i
                                            class="fa fa-edit"></i>
                                        ویرایش
                                    </a>
