        ...
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section class="d-flex justify-content-between align-content-center mt-4 mb-3 border-bottom">
                    <a href="{{route('admin.notify.email.create')}}" class="btn btn-info stn-sm mb-4">ایجاد اطلاعیه
                                                                                                      ایمیلی</a>
                        ...
                        @foreach($emails as $key => $email)
                            <tr>
                                ...
                                <td class="width-16-rem text-left">
                                    ...
                                    <a href="{{route('admin.notify.email-file.index',$email->id)}}" class="btn
                                    btn-warning
                                    btn-sm">
                                    ...
                                    <a href="{{route('admin.notify.email.edit',$email->id)}}" class="btn btn-info
                                    btn-sm">
                                        <i class="fa fa-edit"></i>
                                        ویرایش
                                    </a>

                                    <form class="d-inline" action="{{route('admin.notify.email.destroy',
                                    $email->id)}}"
                                          method="post">
                                        @csrf
                                        {{method_field('delete')}}
