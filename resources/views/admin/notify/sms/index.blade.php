        ...
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section class="d-flex justify-content-between align-content-center mt-4 mb-3 border-bottom">
                    <a href="{{route('admin.notify.sms.create')}}" class="btn btn-info stn-sm mb-4">ایجاد اطلاعیه
                                                                                                    پیامکی</a>
                        ...
                        @foreach($sms as $key => $single_sms)
                            <tr>
                                ...
                                <td class="width-16-rem text-left">
                                    ...
                                    <a href="{{route('admin.notify.sms.edit',$single_sms->id)}}" class="btn btn-info
                                    btn-sm">
                                        <i class="fa fa-edit"></i>
                                        ویرایش
                                    </a>

                                    <form class="d-inline" action="{{route('admin.notify.sms.destroy',
                                    $single_sms->id)}}"
                                          method="post">
                                        @csrf
                                        {{method_field('delete')}}
