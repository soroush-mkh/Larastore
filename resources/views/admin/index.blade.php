...
@section('admin.layouts.head-tag')
            ...
            <a href="#" class="text-decoration-none d-block mb-4">
                <section class="card bg-custom-yellow text-white ">
                    ...
                    <section class="card-footer info-box-footer">
                        <i class="fas fa-clock mx-2"></i> به روز رسانی شده در : 12:42 بعد از ظهر
                    </section>
                </section>
            </a>
        </section>
        ...
        <section class="col-12">
            <section class="main-body-container">
                <section class="main-body-container-header">
                    <h5>کابران</h5>
                    <p>در این بخش اطلاعاتی راجع به کاربران به شما داده می شود.</p>
                </section>
