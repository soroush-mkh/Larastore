        ...
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section class="d-flex justify-content-between align-content-center mt-4 mb-3 border-bottom">
                    <a href="{{route('admin.market.delivery.create')}}" class="btn btn-info stn-sm mb-4">ایجاد روش
                                                                                                         ارسال جدید</a>
                        ...
                        @foreach($delivery_methods as $delivery_method)
                            <tr>
                                ...
                                <td>
                                    <label>
                                        <input id="{{$delivery_method->id}}"
                                               ...
                                               data-url="{{route('admin.market.delivery.status',
                                               $delivery_method->id)}}"
                                               type="checkbox"
                                ...
                                <td class="width-16-rem text-left">
                                    <a href="{{ route('admin.market.delivery.edit',$delivery_method->id) }}" class="btn
                                    btn-primary btn-sm"><i class="fa fa-edit"></i>
                                        ویرایش</a>

                                    <form class="d-inline" action="{{route('admin.market.delivery.destroy',
                                    $delivery_method->id)}}"
                                          method="post">
                                        @csrf
                                        {{method_field('delete')}}
