        ...
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section class="d-flex justify-content-between align-content-center mt-4 mb-3 border-bottom">
                    <a href="{{ route('admin.ticket.category.create') }}" class="btn btn-info stn-sm mb-4">ایجاد دسته بندی</a>
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        @foreach($ticketCategories as $key => $ticketCategory)
                            <tr>
                                ...
                                <td>
                                    <label>
                                        <input id="{{$ticketCategory->id}}" onchange="changeStatus({{$ticketCategory->id}})"
                                               data-url="{{route('admin.ticket.category.status',
                                               $ticketCategory->id)}}"
                                               type="checkbox"
                                ...
                                <td class="width-16-rem text-left">
                                    ...
                                    <a href="{{route('admin.ticket.category.edit',$ticketCategory->id)}}" class="btn btn-info
                                    btn-sm">
                                        <i class="fa fa-edit"></i>
                                        ویرایش
                                    </a>

                                    <form class="d-inline" action="{{route('admin.ticket.category.destroy',
                                    $ticketCategory->id)}}"
                                          method="post">
                                        @csrf
                                        {{method_field('delete')}}
