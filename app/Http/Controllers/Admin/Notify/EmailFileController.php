...
use App\Http\Services\Files\FileService;
...
class EmailFileController extends Controller
{
    ...
    {
        $result = $file->delete();
        return redirect()->route('admin.notify.email-files.index' , $file->email->id)->with('swal-success' , 'فایل مورد نظر با موفقیت حذف شد.');
    }
