...
class TicketPriorityController extends Controller
{
    ...
    {
        $input          = $request->all();
        $ticketPriority = TicketPriority::create($input);

        return redirect()->route('admin.ticket.priority.index')->with('swal-success' , 'اولویت با موفقیت ثبت شد.');
    }
