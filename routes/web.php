...
Route::prefix('admin')->namespace('Amin')->group(function ()
{
    ...
    Route::prefix('market')->namespace('Market')->group(function ()
    {
        ...
        Route::prefix('delivery')->group(function ()
        {
            ...
            Route::delete('/status/{delivery}' , [ DeliveryController::class , 'status' ])->name('admin.market.delivery.status');
        });
        ...
        Route::prefix('payment')->group(function ()
        {
            ...
            Route::get('/cancled/{payment}' , [ PaymentController::class , 'cancled' ])->name('admin.market.payment.cancled');
        ...
        Route::prefix('property')->group(function ()
        {
            ...
            Route::post('/value/sotre/{categoryAttribute}' , [ PropertyValueController::class , 'store' ])->name('admin.market.value.store');
